    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans relative">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-6 py-12 z-10 space-y-12">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <BookOpen className="w-12 h-12 text-[#1565C0] mx-auto mb-3" />
          <h1 className="text-3xl font-extrabold font-serif text-[#1565C0]">Press &amp; Latest News</h1>
          <p className="text-slate-500 text-sm mt-2 leading-relaxed">
            Latest official notices, announcements, and briefings published by the DKFFJ Executive Directorate.
          </p>
          <div className="h-1 w-16 bg-[#C00000] mx-auto mt-4 rounded-full"></div>
        </div>

        {/* Dynamic client-side interactive news layout with details dialog */}
