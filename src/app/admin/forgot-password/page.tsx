...
import { ShieldAlert, Mail, Loader2, AlertCircle, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 sm:p-6 font-sans relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-[#0F4C81] text-lg font-serif font-bold tracking-wider leading-tight">Reset Password</h2>
        ...
        {!successMsg ? (
          ...
          <div className="text-center">
            <p className="text-xs text-slate-400 leading-relaxed mb-6">
              Please check your inbox (and spam folder) for a password reset email from DKFFJ.
            </p>
          </div>
        )}
