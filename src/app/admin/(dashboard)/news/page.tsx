      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-serif font-bold text-slate-800 flex items-center gap-2">
            <Newspaper className="w-5 h-5 text-[#001C55]" /> News & Blog Desk
          </h1>
            ...
            {news.map((post) => (
              <div key={post.id} className="p-4 flex items-center justify-between hover:bg-slate-50/50 transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded bg-[#001C55]/5 border border-slate-250 flex items-center justify-center text-[#001C55] shrink-0">
