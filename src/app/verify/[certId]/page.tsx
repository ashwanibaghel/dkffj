  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans relative">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[15%] left-[50%] -translate-x-1/2 w-[800px] h-[400px] rounded-full bg-[#0F4C81]/[0.02] blur-[100px]"></div>
      </div>
      ...
      <main className="flex-1 max-w-xl w-full mx-auto px-6 py-16 z-10 flex flex-col justify-center">
        {result && result.found ? (
          <div className="bg-white border border-slate-200/80 rounded-3xl overflow-hidden shadow-xl animate-scaleUp">
            ...
            <div className="bg-[#0F4C81] text-white p-8 text-center relative">
          ...
          <div className="bg-white border border-slate-200/80 rounded-3xl p-8 text-center shadow-xl max-w-sm mx-auto">
            ...
            <div className="mt-6 flex flex-col gap-2">
              <Link
                href="/verify"
                className="px-5 py-2.5 rounded-lg bg-[#0F4C81] text-white text-xs font-bold uppercase tracking-wider transition-colors shadow-sm"
              >
