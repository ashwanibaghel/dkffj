...
function WhatsAppIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    ...
    >
      <path d="M13.601 2.326A7.854 7.854 0 0 0 9.61 1.24c-4.318 0-7.827 3.509-7.827 7.827 0 1.38.36 2.728 1.043 3.917l-1.11 4.052 4.15-1.09a7.846 7.846 0 0 0 3.741.952h.003c4.316 0 7.824-3.51 7.824-7.827a7.855 7.855 0 0 0-2.3-5.567 7.826 7.826 0 0 0-1.533-1.178ZM9.61 15.575a6.52 6.52 0 0 1-3.326-.91l-.238-.141-2.46.646.656-2.4-.155-.246a6.523 6.523 0 0 1-1.001-3.456c0-3.593 2.923-6.516 6.519-6.516a6.477 6.477 0 0 1 4.62 1.914 6.479 6.479 0 0 1 1.91 4.622c-.002 3.593-2.923 6.516-6.525 6.516Zm3.573-4.876c-.196-.098-1.158-.572-1.338-.637-.18-.065-.312-.098-.445.098-.13.196-.506.637-.62.767-.114.131-.229.147-.425.049-1.124-.562-1.86-1.002-2.606-2.276-.196-.336.196-.312.562-1.04.062-.13.031-.244-.016-.342-.049-.098-.445-1.076-.61-1.473-.16-.389-.323-.336-.445-.342-.114-.006-.245-.007-.376-.007a.721.721 0 0 0-.522.245c-.18.196-.686.67-.686 1.633 0 .96.702 1.889.8 2.02.098.13 1.38 2.107 3.34 2.953.467.202.832.322 1.116.413.469.149.895.128 1.231.077.376-.056 1.157-.473 1.321-.93.164-.457.164-.85.115-.932-.049-.082-.18-.13-.376-.228Z" />
    </svg>
  );
}
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f0f7ff] text-slate-900 flex flex-col font-sans relative pb-16 md:pb-0">
      ...
      >
        <WhatsAppIcon className="w-6 h-6 md:w-5 md:h-5 text-white shrink-0" />
