  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans relative">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[10%] left-[20%] w-[700px] h-[500px] rounded-full bg-[#0F4C81]/[0.02] blur-[120px]"></div>
      </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-12 z-10">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <GraduationCap className="w-12 h-12 text-[#0F4C81] mx-auto mb-3" />
          <h1 className="text-3xl font-extrabold font-serif text-[#0F4C81]">DKFFJ Academy Portal</h1>
