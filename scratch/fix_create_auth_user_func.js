...
async function main() {
  ...
  console.log("Re-creating database function public.create_auth_user without confirmed_at...");
  try {
    await prisma.$executeRawUnsafe(sql);
    console.log("Successfully fixed and re-created public.create_auth_user function.");
  } catch (err) {
